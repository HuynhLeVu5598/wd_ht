  ...
  return (
    <LazyMotion features={domAnimation} strict>
      <div
        ...
        style={{ "--wedding-bg-url": `url(${bg})` } as React.CSSProperties}
      >
        <audio
          ref={audioRef}
        ...
        >
          ...
          >
            ...
            <h1 className="text-3xl sm:text-4xl md:text-6xl font-serif mb-3 md:mb-4 title-glow px-4 leading-tight">
              Hoàng <span className="text-pink-300 font-sans amp-pulse">&</span> Thảo
            </h1>
          ...
          {/* Khung ảnh — căn giữa bằng flex, tránh lệch do transform */}
